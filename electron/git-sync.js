...
const MODE_COMMIT_PREFIX = {
  ...
  'release-checklist': 'chore(release-checklist)',
  status: 'docs(status)',
  security: 'fix(security)',
  seo: 'seo',
  'seo-content': 'seo',
  competitors: 'docs(competitors)',
  content: 'content',
  monitoring: 'chore(monitoring)',
  forms: 'fix(forms)',
  translate: 'i18n',
  analytics: 'feat(analytics)',
  'freelance-tz': 'docs(tz)',
  'freelance-email': 'docs(client)',
  'freelance-estimate': 'docs(estimate)',
  custom: 'chore(dev-agent)',
};

const REPORT_FILES = {
  check: 'DEV-AGENT-ОТЧЁТ.md',
  release: 'DEV-AGENT-ОТЧЁТ.md',
  'release-checklist': 'РЕЛИЗ-ЧЕКЛИСТ.md',
  status: 'СТАТУС.md',
  security: 'DEV-AGENT-ОТЧЁТ.md',
  seo: 'SEO-ОТЧЁТ.md',
  'seo-content': 'SEO-ОТЧЁТ.md',
  competitors: 'КОНКУРЕНТЫ.md',
  content: 'КОНТЕНТ-ОТЧЁТ.md',
  monitoring: 'МОНИТОРИНГ.md',
  forms: 'ФОРМЫ-ОТЧЁТ.md',
  translate: 'DEV-AGENT-ОТЧЁТ.md',
  analytics: 'АНАЛИТИКА.md',
  'freelance-tz': 'ТЗ-ЗАКАЗ.md',
  'freelance-email': 'ПИСЬМО-КЛИЕНТУ.md',
  'freelance-estimate': 'СМЕТА.md',
  custom: 'DEV-AGENT-ОТЧЁТ.md',
};
